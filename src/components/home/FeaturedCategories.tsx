          ...
          {CATEGORIES_META.map((cat, idx) => {
            ...
            return (
              <Link
                ...
                className="group relative flex flex-col justify-end min-h-[210px] sm:min-h-[220px] rounded-2xl overflow-hidden shadow-xs hover:shadow-xl border border-border hover:border-accent transition-all duration-300 hover:-translate-y-1 cursor-pointer"
              >
                ...
                <div className="absolute top-3 left-3 z-10">
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-accent/90 backdrop-blur-md text-primary shadow-xs">
                ...
                <div className="absolute top-3 right-3 z-10">
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-black/60 backdrop-blur-md text-accent border border-white/20 shadow-xs">
                ...
                <div className="relative z-10 p-4 space-y-1">
                  <h3 className="font-heading font-extrabold text-base sm:text-lg text-white tracking-tight leading-snug group-hover:text-accent transition-colors duration-200">
                    {cat.name}
                  </h3>
