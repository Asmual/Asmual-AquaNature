...
export const Navbar = () => {
  ...
  const fishCategories = [
    { name: "Fighter / Betta", desc: "Alien, Dumbo, Red Dragon, Koi Bettas", href: "#" },
    { name: "Guppy Collection", desc: "24k Gold, Albino Blue Topaz, Moscow", href: "#" },
    { name: "Mix Freshwater", desc: "Tetras, Mollies, Angels & Community Fish", href: "#" },
    { name: "SeaWater Fish", desc: "Marine clownfishes, tangs & reef species", href: "#" },
  ];

  const plantCategories = [
    { name: "Indoor Plants", desc: "Monstera, Peace Lily, Snake Plants, ZZ", href: "#" },
    { name: "Bonsai Plants", desc: "Miniature living art and dwarf trees", href: "#" },
    { name: "Flower Plants", desc: "Water lilies, roses, seasonal bloomers", href: "#" },
  ];

  return (
    <header className="w-full sticky top-0 z-50 transition-all duration-200">
      {/* 1. TOP BAR (Deep Navy-Teal #0B4A6F) */}
      <div className="bg-primary text-white text-xs font-medium py-2 px-4 sm:px-6 lg:px-8 border-b border-primary-dark">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 text-center sm:text-left">
            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-accent text-primary">
              Notice
            </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-4 lg:gap-8">
            ...
            <Link href="/" className="flex items-center gap-3 group shrink-0">
              <div className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-full overflow-hidden border border-border group-hover:border-accent transition-all duration-300 p-0.5 bg-surface">
                <Image
              ...
              <div className="flex flex-col">
                <span className="font-heading font-extrabold text-xl sm:text-2xl text-primary tracking-tight leading-none group-hover:text-primary-dark transition-colors">
                  Asmual <span className="text-accent">AquaNature</span>
                </span>
                <span className="text-[10px] sm:text-[11px] font-semibold text-muted-foreground tracking-wider uppercase mt-0.5">
